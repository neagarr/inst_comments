...
#     create_engine, Column, Integer, String, Text, Boolean, DateTime, Enum
# )
...
#     analysis_number = Column(Integer)
#     analysis_date = Column(DateTime)
#     prompt_text = Column(Text)
#     comment_status = Column(
#         Enum("support", "disagree", "unclear", name="comment_status_enum"),
#         nullable=True
#     )
#     against_northwest = Column(Boolean, default=False)
#     against_shelf = Column(Boolean, default=False)
#     against_burrup = Column(Boolean, default=False)
#     narrative_a = Column(Boolean, default=False)
#     narrative_b = Column(Boolean, default=False)
#     accusation_of_lies = Column(Boolean, default=False)
#     coordination_signs = Column(Boolean, default=False)
